...
sub username { $_[0]->config->{endpoint_username} }
sub password { $_[0]->config->{endpoint_password} }
...
SendRequestAdditionalGroupAuthenticated => {
    soapaction => 'http://www.symology.co.uk/services/SendRequestAdditionalGroupAuthenticated',
    namespace => 'http://www.symology.co.uk/services',
    parameters => [
      SOAP::Data->new(name => 'tns:Username', type => 's:string', attr => {}),
      SOAP::Data->new(name => 'tns:Password', type => 's:string', attr => {}),
      SOAP::Data->new(name => 'tns:ProcessID', type => 's:string', attr => {}),
      SOAP::Data->new(name => 'tns:Request', type => 'tns:RequestSend', attr => {}),
      SOAP::Data->new(name => 'tns:Customer', type => 'tns:CustomerSend', attr => {}),
      SOAP::Data->new(name => 'tns:AdditionalFields', type => 'tns:ArrayOfAdditionalFieldSend', attr => {}),
  ...
  }, # end SendRequestAdditionalGroupAuthenticated
SendEventAction => {
...
SendEventActionAuthenticated => {
    soapaction => 'http://www.symology.co.uk/services/SendEventActionAuthenticated',
    namespace => 'http://www.symology.co.uk/services',
    parameters => [
      SOAP::Data->new(name => 'tns:Username', type => 's:string', attr => {}),
      SOAP::Data->new(name => 'tns:Password', type => 's:string', attr => {}),
  ...
  }, # end SendEventActionAuthenticated
...
'GetRequestAdditionalGroupAuthenticated' => {
    soapaction => 'http://www.symology.co.uk/services/GetRequestAdditionalGroupAuthenticated',
    namespace => 'http://www.symology.co.uk/services',
    parameters => [
      SOAP::Data->new(name => 'tns:Username', type => 's:string', attr => {}),
      SOAP::Data->new(name => 'tns:Password', type => 's:string', attr => {}),
  ...
  }, # end GetRequestAdditionalGroupAuthenticated
); # end my %methods
...
sub _send_with_username {
    my $self = shift;
    my $fn = shift;
    my @credentials;
    if ($self->username) {
        $fn .= 'Authenticated';
        push @credentials, $self->username, $self->password;
    }
    my $response = $self->$fn(@credentials, @_);
    return $response;
}

sub send_request { shift->_send_with_username('SendRequestAdditionalGroup', undef, @_) }
sub send_update { shift->_send_with_username('SendEventAction', undef, @_) }
sub get_request { shift->_send_with_username('GetRequestAdditionalGroup', @_) }
