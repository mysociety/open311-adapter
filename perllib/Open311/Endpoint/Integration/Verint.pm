...
sub post_service_request {
    ...
    foreach (@photos) {
        ...
        my $result = $integ->AttachFileRequest($self->endpoint_config, $ref, $_->[0], $encoded, $_->[2], "txt_filename");
...
sub get_service_request_updates {
    ...
    my $result = $integ->searchAndRetrieveCaseDetails($self->endpoint_config,
        ixhash(
