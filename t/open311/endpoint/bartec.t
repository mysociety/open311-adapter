...
my %responses = (
  ...
  <AuthenticateResult xmlns="http://www.bartec-systems.com">
    ...
    ServiceRequests_Notes_Create => '<ServiceRequests_Notes_CreateResult />',
);
...
subtest "check send basic report" => sub {
    ...
    my $res = $endpoint->run_test_request(
        ...
        'attribute[closest_address]' => 'Nearest road to the pin placed on the map (automatically generated by Bing Maps): Nearest address',
    );
    ...
    is_deeply $create_req->body->{ServiceRequests_Create}, {
        ...
        LandTypeID => 12,
        SLAID => 13,
        serviceLocationDescription => "Nearest address",
...
subtest "check send report with a photo" => sub {
    ...
    my $res = $endpoint->run_test_request(
        ...
        'attribute[street]' => 'a street',
        'attribute[postcode]' => 'AB1 1BA',
        'attribute[closest_address]' => 'Nearest address',
