        ...
        service_request_updates => {
            request_update => [
                ...
                {   description          => undef,
                    ...
                    extras               => { category => 'Flooding', group => 'Flooding & Drainage', targetDate => '2018-04-01T12:00:00+00:00', defectAttrib_priority => 'High', defectAttrib_severity => 1 },
                },
                {   description          => undef,
                    external_status_code => 'INP',
                    media_url            => undef,
                    ...
                    extras               => { category => 'Flooding', group => 'Flooding & Drainage', defectAttrib_priority => 'Medium' },
                },
                {   description          => undef,
                    external_status_code => 'INP',
                    media_url            => undef,
